...
public class MyMapper implements Mapper {
    ...
    {
    	outputValue.setBigint("c_bro", 0L);
    	outputValue.setBigint("c_fav", 0L);
    	outputValue.setBigint("c_cart", 0L);
    	outputValue.setBigint("c_buy", 0L);
    ...
    private void featureEngineering(Record originalRecord, Record outputValue)
    {
    	...
    	case 1:
    		outputValue.setBigint("c_bro", 1L);
    		break;
    	//add favorite action features here
    	case 2:
    		outputValue.setBigint("c_fav", 1L);
    		break;
    	//add cart action features here
    	case 3:
    		outputValue.setBigint("c_cart", 1L);
    		break;
    	//add buy action features here
    	case 4:
    		outputValue.setBigint("c_buy", 1L);
    		break;
    	default:
    		break;
    	}
